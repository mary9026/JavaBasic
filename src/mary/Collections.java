...
public class Collections {
    public static void main(String[] args) {
        Object[] zoo = new Object[10]; // Object 클래스는 모든 클래스의 조상격

        // 동물들을 동물원 우리에 가둠
        // 일반적으로 배열은 동일한 유형의 자료들을 저장하는 자료구조
        // 하지만, 배열의 유형을 Object로 선언하면 온갖 종류의 데이터들을 저장할 수 있음
        zoo[0] = new Tiger(); // upcasting 적용 // Tiger 자식클래스가 object 부모 클래스로 자동형변환(upcasting)됨
        zoo[1] = new Lion();
        zoo[2] = new Zebra();
        ...
        // 적절한 형변환이 필요함 !
        // Tiger t1 = zoo[0]; 타입 불일치로 오류남
        Tiger t1 = (Tiger)zoo[0]; // downcasting / 자식클래스로 형변환
        Lion l1 = (Lion)zoo[1];
...
//        z1 = zoo.get(2);
        ...
        zoo4.add(new Lion());
        l1 = zoo4.get(0); // 두가지 방법을 모두 쓸 수 있음
