...
public class OOP {
    public static void main(String[] args) {
        ...
        Person bak = new Person("재성", "프로그래머", 30, "남", "O");
        ...
        System.out.println(bak.job);
        System.out.println(bak.age);
        System.out.println(bak.gender);
        System.out.println(bak.blood);
